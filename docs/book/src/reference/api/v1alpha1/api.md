...
<p>
(<em>Appears on:</em>
<a href="#infrastructure.cluster.x-k8s.io/v1alpha1.LXCClusterTemplateSpec">LXCClusterTemplateSpec</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="#infrastructure.cluster.x-k8s.io/v1alpha1.LXCClusterTemplate">LXCClusterTemplate</a>)
</p>
<p>
