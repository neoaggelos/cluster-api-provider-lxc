...
<td>
<em>(Optional)</em>
<p>CustomHAProxyConfigTemplate allows you to replace the default HAProxy config file content.
Please use it with caution, as there are no checks to ensure the validity of the configuration.</p>
</td>
</tr>
</tbody>
</table>
