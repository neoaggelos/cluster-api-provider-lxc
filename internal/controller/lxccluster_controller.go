...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=lxcclusters/finalizers,verbs=update
...
func (r *LXCClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
