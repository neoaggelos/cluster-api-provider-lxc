...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=lxcmachines/finalizers,verbs=update
...
func (r *LXCMachineReconciler) SetupWithManager(mgr ctrl.Manager) error {
