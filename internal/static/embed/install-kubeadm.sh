...
CRICTL_VERSION="${CRICTL_VERSION:-v1.37.0}"               # https://github.com/kubernetes-sigs/cri-tools
CONTAINERD_VERSION="${CONTAINERD_VERSION:-v2.3.5}"        # https://github.com/containerd/containerd
RUNC_VERSION="${RUNC_VERSION:-v1.4.2}"                    # https://github.com/opencontainers/runc, must match https://raw.githubusercontent.com/containerd/containerd/v2.3.5/script/setup/runc-version
...
# Sourced from: https://raw.githubusercontent.com/kubernetes/release/v0.21.0/cmd/krel/templates/latest/kubeadm/10-kubeadm.conf
